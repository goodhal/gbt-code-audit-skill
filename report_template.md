...
| GB/T 34944-2017（Java专用） | XX | 6-14 章 |
| **合计** | **XX** | |
...
**状态说明**：
- `☑ 通过`：该项检查通过
- `☐ 缺失/存疑/错误/需关注/不可修复 (X 条)`：该项存在问题，括号内填写具体数量
...
**审计工具**：SpotBugs + FindSecurityBugs + LLM审计  
**审计范围**：[审计的目录范围]  
**审计时长**：[约 X 小时]
